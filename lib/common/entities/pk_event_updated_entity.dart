...
class PkEventUpdatedAwayInfo {
  ...
  factory PkEventUpdatedAwayInfo.fromJson(Map<String, dynamic> json) =>
      $PkEventUpdatedAwayInfoFromJson(json);
...
class PkEventUpdatedHomeInfo {
  ...
  factory PkEventUpdatedHomeInfo.fromJson(Map<String, dynamic> json) =>
      $PkEventUpdatedHomeInfoFromJson(json);
