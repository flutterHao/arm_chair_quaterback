...
class StarUpDefineEntity {
	...
	factory StarUpDefineEntity.fromJson(Map<String, dynamic> json) => $StarUpDefineEntityFromJson(json);
	...
	double getPotantialMax(){
		return double.parse(potantialRang.split(",")[potantialRang.length==1?0:1])*100;
	}
	@override
	String toString() {
