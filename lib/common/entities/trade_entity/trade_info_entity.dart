...
class TradeInfoTotalSalary {
  ...
  factory TradeInfoTotalSalary.fromJson(Map<String, dynamic> json) =>
      $TradeInfoTotalSalaryFromJson(json);
...
class TradeInfoTradePlayersTrend {
  ...
  factory TradeInfoTradePlayersTrend.fromJson(Map<String, dynamic> json) =>
      $TradeInfoTradePlayersTrendFromJson(json);
