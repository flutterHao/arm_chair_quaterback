...
class ReciveAwardV2Entity {
	...
	factory ReciveAwardV2Entity.fromJson(Map<String, dynamic> json) => $ReciveAwardV2EntityFromJson(json);
...
class ReciveAwardV2GuessInfo {
	...
	factory ReciveAwardV2GuessInfo.fromJson(Map<String, dynamic> json) => $ReciveAwardV2GuessInfoFromJson(json);
...
class ReciveAwardV2GuessInfoGuessData {
	...
	factory ReciveAwardV2GuessInfoGuessData.fromJson(Map<String, dynamic> json) => $ReciveAwardV2GuessInfoGuessDataFromJson(json);
