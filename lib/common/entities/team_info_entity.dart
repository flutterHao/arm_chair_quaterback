...
class TeamInfoEntity {
	...
	factory TeamInfoEntity.fromJson(Map<String, dynamic> json) => $TeamInfoEntityFromJson(json);
...
class TeamInfoTeamPreference {
	...
	factory TeamInfoTeamPreference.fromJson(Map<String, dynamic> json) => $TeamInfoTeamPreferenceFromJson(json);
