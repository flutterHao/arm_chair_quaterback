...
class GuessParamEntity {
	...
	factory GuessParamEntity.fromJson(Map<String, dynamic> json) => $GuessParamEntityFromJson(json);
...
class GuessParamGuessData {
	...
	factory GuessParamGuessData.fromJson(Map<String, dynamic> json) => $GuessParamGuessDataFromJson(json);
