...
class NewTestEntity {
	...
	factory NewTestEntity.fromJson(Map<String, dynamic> json) => $NewTestEntityFromJson(json);
...
class NewTestAst {
	...
	factory NewTestAst.fromJson(Map<String, dynamic> json) => $NewTestAstFromJson(json);
...
class NewTestAstGuessReferenceValue {
	...
	factory NewTestAstGuessReferenceValue.fromJson(Map<String, dynamic> json) => $NewTestAstGuessReferenceValueFromJson(json);
...
class NewTest3pt {
	...
	factory NewTest3pt.fromJson(Map<String, dynamic> json) => $NewTest3ptFromJson(json);
...
class NewTest3ptGuessReferenceValue {
	...
	factory NewTest3ptGuessReferenceValue.fromJson(Map<String, dynamic> json) => $NewTest3ptGuessReferenceValueFromJson(json);
...
class NewTestPts {
	...
	factory NewTestPts.fromJson(Map<String, dynamic> json) => $NewTestPtsFromJson(json);
...
class NewTestPtsGuessReferenceValue {
	...
	factory NewTestPtsGuessReferenceValue.fromJson(Map<String, dynamic> json) => $NewTestPtsGuessReferenceValueFromJson(json);
