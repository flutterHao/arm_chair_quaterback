...
class NbaPlayerRankInfo {
  ...
  factory NbaPlayerRankInfo.fromJson(Map<String, dynamic> json) =>
      $NbaPlayerRankInfoFromJson(json);

  Map<String, dynamic> toJson() => $NbaPlayerRankInfoToJson(this);
