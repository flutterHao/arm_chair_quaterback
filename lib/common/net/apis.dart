 ...
 * @LastEditTime: 2025-02-27 20:06:50
 */
class Api {
  /// base
  ...
  static const String getSeasonRankInfo = '$API_BASE_PATH/team/getSeasonRankInfo';
  static const String getSeasonRankAward = '$API_BASE_PATH/team/getSeasonRankAward';
  static const String likePlayer = '$API_BASE_PATH/team/likePlayer';
  static const String cancelLikingPlayer = '$API_BASE_PATH/team/cancelLikingPlayer';
  ...
  static const String getReviewsByNewsId = "$API_BASE_PATH//NBANews/getReviewsByNewsId";
  ...
  static const String getRelevantNews = "$API_BASE_PATH/NBANews/getRelevantNews";
  static const String getGuessRankByCycle = "$API_BASE_PATH/NBANews/getGuessRankByCycle";
  ...
  ///NBAData
  static const String statTeamRank = "$API_BASE_PATH/NBAData/getNBATeamPerGameAndTotalInfo";
  static const String teamRank = "$API_BASE_PATH/NBAData/queryNBATeamRank";

  static const String playerStats = "$API_BASE_PATH/NBAData/getNBAPlayerPerGameAndTotalsInfo";
  ...
  static const String getNotStartGameData = "$API_BASE_PATH/NBAData/getNotStartGameData";
  static const String getNBAGameHeaderData = "$API_BASE_PATH/NBAData/getNBAGameHeaderData";
  static const String getNBAGamePicks = "$API_BASE_PATH/NBAData/getNBAGamePicks";
  ...
  static const String cPlayerStatsDefine = "$CONFIG_BASE_PATH/PlayerStatsDefine.json";
  ...
  static const String cSourceTranslate = "$CONFIG_BASE_PATH/SourceTranslate.json";
  ...
  static const String cPlayerBookExpRule = "$CONFIG_BASE_PATH/PlayerBookExpRule.json";
  static const String cGameConstant = "$CONFIG_BASE_PATH/GameConstant.json";
  static const String cPlayerPowerRateDefine = "$CONFIG_BASE_PATH/PlayerPowerRateDefine.json";
  ...
  static const String cWheelRewardType = "$CONFIG_BASE_PATH/WheelRewardType.json";
  ...
  static const String getTrainingInfo = "$API_BASE_PATH/TeamPlayer/getTrainingInfo";
  static const String playerTraining = "$API_BASE_PATH/TeamPlayer/playerTraining";
  ...
  static const String upStarTeamPlayer = "$API_BASE_PATH/TeamPlayer/upStarTeamPlayer";
  static const String getAllTeamPlayersByUpStar = "$API_BASE_PATH/TeamPlayer/getAllTeamPlayersByUpStar";
  static const String getAllTeamPlayerByTrend = "$API_BASE_PATH/TeamPlayer/getAllTeamPlayerByTrend";
  static const String replyPower = "$API_BASE_PATH/TeamPlayer/replyPower";
  static const String getTeamPlayers = "$API_BASE_PATH/TeamPlayer/getTeamPlayers";
  ...
  static const String buyTrainingBall = "$API_BASE_PATH/TeamPlayer/buyTrainingBall";
  ...
  static const String getGameSchedules = "$API_BASE_PATH/match/getGameSchedules";
  static const String getGameResultInfo = "$API_BASE_PATH/match/getGameResultInfo";
  ...
  ///mission
  static const String getTeamMissionList = "$API_BASE_PATH/mission/getTeamMissionList";
  static const String getTeamMissionAward = "$API_BASE_PATH/mission/getTeamMissionAward";
  ...
  ///Girl
  static const String getSlotChatEventVO = "$API_BASE_PATH/Girl/getSlotChatEventVO";
