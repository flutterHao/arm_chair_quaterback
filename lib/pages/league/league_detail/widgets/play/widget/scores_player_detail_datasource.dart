...
class ScoresPlayerDetailDatasource extends DataGridSource{
  ScoresPlayerDetailDatasource(this.playerScores);

  final List<NbaGameDetailGameDataPlayerScores> playerScores;
