...
//               controller.girlGiftDefineList[index].cost.split('_').toList();
//           int propid = int.parse(controller.girlGiftDefineList[index].id);
//           return MtInkWell(
//               onTap: () {
//                 controller.sendGiftClick(
//                     girlId: controller.gGirlDefine.value.id,
//                     giftId: propid,
//                     costList: costList);
//               },
//               child: Container(
...
//       decoration: BoxDecoration(
//           color: AppColors.c000000, borderRadius: BorderRadius.circular(9.w)),
//       child: Row(
//         children: [
