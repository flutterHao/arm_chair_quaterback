 ...
 */
class BeautyAndBoxView extends GetView<TeamIndexController> {
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(
                        ...
                        child: MtInkwell(
                          onTap: () {
                            if (!controller.box1Claimed.value) {
                              showDialog(
                                  context: Get.context!,
                                  builder: (context) {
                                    return CustomDialog(
                                        ...
                                        onTap: () {
                                          controller.claimBox(1);
                                        });
                                  });
                            } else if (!controller.box2Claimed.value) {
                              Get.dialog(CustomDialog(
                                  content: _rewardContent(),
                                  onTap: () {
                                    controller.claimBox(2);
                                  }));
                            }
                          },
                          child: SizedBox(
