...
class OVRFilterDialog extends GetView<NbaPlayerController> {
  const OVRFilterDialog({super.key});
    ...
    return VerticalDragBackWidget(
      child: SimpleBottomDialog(
        ...
        onComfirm: () {
          ...
          // controller.currentIndexChange(0);
          // controller.allPlayerStrengthRank.refresh();
          Get.back();
        },
        onCencel: () {
          controller.reset();
...
class _Position extends GetView<NbaPlayerController> {
...
class _Grade extends GetView<NbaPlayerController> {
...
class _Teams extends GetView<NbaPlayerController> {
