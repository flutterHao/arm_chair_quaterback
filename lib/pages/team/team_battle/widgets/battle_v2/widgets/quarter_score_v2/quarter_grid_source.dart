...
class QuarterGridSourceV2 extends DataGridSource {
  QuarterGridSourceV2(this.controller, this.quarter);
    ...
    List<Widget> cells = row.getCells().map((e) {
      if (e.columnName == "id") {
        ...
        return Container(
          decoration: BoxDecoration(
              ...
              border: Border(
                  top: BorderSide(color: AppColors.c000000, width: 2.w))),
      ...
      return Container(
        decoration: BoxDecoration(
            color: AppColors.cBD1C09,
            border:
                Border(top: BorderSide(color: AppColors.c000000, width: 2.w))),
        child: Center(
          child: Text(
            (e.value == 0 ? "--" : e.value).toString(),
