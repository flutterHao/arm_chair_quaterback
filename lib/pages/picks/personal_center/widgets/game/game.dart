...
class _GameState extends State<Game>
  ...
  Widget build(BuildContext context) {
    controller = Get.find();
    return GetBuilder<PersonalCenterController>(builder: (logic) {
      easyAnimationController ??= EasyAnimationController(
          vsync: this,
          begin: 0,
          end: 1,
        ...
        slivers: [
          ...
          SliverList.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return Container(
                  margin: EdgeInsets.only(
                      top: 13.w, right: 16.w, bottom: lastItem ? 20.w : 0),
                  height: 84.w,
                  width: double.infinity,
                  child: Stack(
                        ...
                        Container(
                          ...
                          child: RotatedBox(
                              ...
                              child: Text(
                                ...
                                style:
                                    21.w7(color: AppColors.c2170D2, height: 1),
                              )),
                        ),
                      Container(
                        height: 84.w,
                        ...
                        child: Row(
                          children: [
                            ...
                            PlayerAvatarWidget(
                              width: 64.w,
                              playerId: player.baseInfo.playerId,
                              isMyPlayer: controller.teamId ==
                              ...
                              level: player.teamPlayerEntity
                                  .getBreakThroughGrade(),
