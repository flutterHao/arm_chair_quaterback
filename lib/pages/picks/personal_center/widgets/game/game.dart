                      ...
                      child: Column(
                        children: [
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        "${controller.teamInfoEntity?.teamExp ??
                                            0}/${controller.nextLevelTotalExp}",
                          ...
                          Row(
                            children: [
                              Text(
                                "Next stage (lv.${controller.nextLevelRuleConfig
                                    ?.grade ?? 0})",
                                style:
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    Text(
                                      "${controller.currentLevelRuleConfig
                                          ?.salaryCap ?? 0}",
                                    ...
                                    Text(
                                      "${controller.nextLevelRuleConfig
                                          ?.salaryCap ?? 0}",
