          ...
          return Stack(
            children: [
              SingleChildScrollView(
                ...
                child: Stack(
                  alignment: controller.awardInfo.isEmpty
                      ? Alignment.center
                  ...
                  children: [
                    ...
                    controller.awardInfo.isEmpty
                        ? Center(
                            child: LoadStatusWidget(
                            onRefreshTap: controller.reloadRewardData,
                          ))
                        : Container(
                            width: MediaQuery.of(context).size.width,
                            // color: Colors.red,
                            margin: EdgeInsets.only(
                                top: 564.w, left: 16.w, right: 16.w),
