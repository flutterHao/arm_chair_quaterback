            ...
            children: [
              ...
              Container(
                ...
                margin: EdgeInsets.only(
                    top: MediaQuery.of(context).padding.top + 48.w + 6.w + 422.w,
                    left: 16.w,
                    right: 16.w),
                        ...
                        children: [
                          Flexible(
                            ...
                            child: Container(
                              height: 77.w,
                              width: 156.w,
                              padding: EdgeInsets.symmetric(vertical: 3.w,horizontal: 13.w),

                              decoration: const BoxDecoration(
                                image: DecorationImage(image: AssetImage(Assets.uiRankBoxPng),fit: BoxFit.fill)
                              ),
                              child: Column(
                          ...
                          Flexible(
                            ...
                            child: Container(
                              ...
                              padding: EdgeInsets.symmetric(vertical: 3.w,horizontal: 13.w),
                              decoration: const BoxDecoration(
                                  image: DecorationImage(image: AssetImage(Assets.uiRankMoneyPng),fit: BoxFit.fitWidth)
                              ),
                              child: Column(
                                mainAxisAlignment: MainAxisAlignment.start,
                                crossAxisAlignment: CrossAxisAlignment.start,
                              ...
                              child: Row(
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      Image.asset(Assets.testTeamLogoPng,width: 28.w,),
