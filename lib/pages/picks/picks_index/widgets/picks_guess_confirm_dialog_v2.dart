...
class _PicksGuessConfirmDialogV2State extends State<PicksGuessConfirmDialogV2> {
    ...
    scrollController.addListener(() {
      if (listener == null) {
        scrollController.position.isScrollingNotifier
          ...
          if((startPixels == scrollController.position.minScrollExtent&& height == maxHeight)){
  ...
  Widget build(BuildContext context) {
    ...
    maxHeight = min(maxHeight, queryData.size.height-queryData.padding.top-queryData.padding.bottom);
