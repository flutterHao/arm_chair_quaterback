                  ...
                  child: Obx(() {
                    return Container(
                        ...
                        child: LoadStatusWidget(
                          text: picksIndexController.loadStatusRx.value
                              .desc,));
                  }))
            else
              ...[
                if (picksIndexController.picksPlayers.isNotEmpty) ...[
                  ...
                  SliverList(
                    delegate: SliverChildBuilderDelegate(
                          (_, index) {
                        var player =
                        picksIndexController.picksPlayers[index];
                        return GuessItem(index, player);
                      },
                      childCount: picksIndexController.picksPlayers
                          .length,
                    ),
                  ),
                ],
                  ...
                  SliverFixedExtentList(
                      delegate: SliverChildBuilderDelegate(
                          childCount: picksIndexController
                              .rankInfo.ranks.length, (_, index) {
                        RankInfoEntity item =
                        picksIndexController.rankInfo.ranks[index];
                        int selfIndex = picksIndexController.rankInfo
                            .ranks
                            .indexWhere((e) =>
                        e.teamId ==
                        ...
                        var len =
                            picksIndexController.rankInfo.ranks.length;
                        return InkWell(
                          onTap: () =>
                              Get.toNamed(
                          ...
                          child: Container(
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  borderRadius: index == 9
                                      ...
                                      : null),
                              padding:
                              EdgeInsets.only(left: 24.w, right: 26.w),
                              margin:
