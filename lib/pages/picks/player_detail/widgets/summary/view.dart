...
class SummaryPage extends StatefulWidget {
  SummaryPage({required this.playerId, super.key});
  final int playerId;
...
class _SummaryPageState extends State<SummaryPage>  with AutomaticKeepAliveClientMixin{
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<SummaryController>(
      init: controller = SummaryController(widget.playerId),
          ...
          physics: const BouncingScrollPhysics(),
                child: Column(
                  ...
                  children: [
                                                          ...
                                                          child: Column(
                                                            ...
                                                            children: [
                                                              ...
                                                              Text(
                                                                "MORE",
                                                                style: 10.w7(
                                                                    color: controller.pickIndex.value ==
                                                                            0
                                                                        ? AppColors
                                                                            .cF2F2F2
                                                                        : AppColors
                                        ...
                                        children: [
                                          ...
                                          Builder(builder: (context) {
                                            ...
                                            if (communityPick.moreCount == 0 &&
                                              ...
                                              morePercent = communityPick
                                                      .moreCount /
                                                  (communityPick.moreCount +
                                                      communityPick.lessCount);
                                            }
                                            int moreFlex = int.parse(
                                                (morePercent)
                                                    .toStringAsFixed(0));
                                            return Column(
                                              children: [
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Text(
                                            "vs ${Utils.getTeamInfo(controller.getVsTeams()[0].awayTeamId).shortEname}",
                                            style: 14.w7(
                                                color: AppColors.c262626,
                                                height: 1),
                                          ),
                    ...
                    Builder(builder: (context) {
                      if (controller
                              .nbaPlayerBaseInfoEntity?.playerNews.isEmpty ==
                          true) {
                        return const SizedBox.shrink();
                      }
                      return Column(
                        ...
                        children: [
                          ...
                          ...List.generate(
                              controller.nbaPlayerBaseInfoEntity!.playerNews
                                  .length, (index) {
                            var playerNew = controller
                                .nbaPlayerBaseInfoEntity!.playerNews[index];
                            return InkWell(
                              onTap: () {
                                Get.find<NewListController>()
                                    .getNewsFlow(playerNew.id);
                                Get.toNamed(RouteNames.newsDetail,
                                    arguments: playerNew.id);
                              },
                              child: Container(
                                width: double.infinity,
                                margin: EdgeInsets.only(
                                    left: 16.w, right: 16.w, top: 13.w),
                                decoration: BoxDecoration(
                                    color: AppColors.cF2F2F2,
                                    borderRadius: BorderRadius.circular(16.w)),
                                padding: EdgeInsets.only(
  ...
  List<Widget> getVsWidget() {
    ...
    List<Widget> list = vsTeams.fold([], (p, e) {
      ...
      var value = e.toJson()[key.toLowerCase()];
