    ...
    return Center(
      child: Container(
        ...
        child: Stack(
          ...
          children: [
            Text("DEFEAT",style: 52.w7(color: AppColors.cB3B3B3,height: 1),),
            Container(
            ...
            Positioned(
              top: 15.w,
                child: IconWidget(iconWidth: 111.w, icon: Assets.testTeamLogoPng)),
            Container(
              ...
              child: DialogBackground(
                ...
                frontColor: AppColors.cF2F2F2, child: Stack(
                    ...
                    child: Column(
                      children: [
                        Stack(
                          alignment: Alignment.center,
                          children: [
                            IconWidget(iconWidth: 97.w, icon: Assets.uiIconStar_01Png,iconColor: AppColors.cBFBFBF,),
                            Positioned(
                              top: 30.w,
                                child: Text("5",style: 56.w7(color: AppColors.c262626,height: 1),))
                          ],
                        ),
                        19.vGap,
                        Text("Remains Unchanged",style: 14.w4(color: AppColors.cB2B2B2,height: 1),)
                      ],
                    ),
                  ),
                  Positioned(
