...
NbaPlayerBaseInfoEntity $NbaPlayerBaseInfoEntityFromJson(
  ...
  final NbaPlayerRankInfo? playerRegularMap = jsonConvert.convert<
      NbaPlayerRankInfo>(json['playerRegularMap']);
  ...
  final NbaPlayerRankInfo? playerPlayoffsMap = jsonConvert.convert<
      NbaPlayerRankInfo>(json['playerPlayoffsMap']);
  ...
  final NbaPlayerRankInfo? teamPreSeasonRankInfoMap = jsonConvert.convert<
      NbaPlayerRankInfo>(json['teamPreSeasonRankInfoMap']);
  if (teamPreSeasonRankInfoMap != null) {
    nbaPlayerBaseInfoEntity.teamPreSeasonRankInfoMap = teamPreSeasonRankInfoMap;
  }
...
extension NbaPlayerBaseInfoEntityExtension on NbaPlayerBaseInfoEntity {
  NbaPlayerBaseInfoEntity copyWith({
    ...
    NbaPlayerRankInfo? playerRegularMap,
...
extension NbaPlayerRankInfoExtension on NbaPlayerRankInfo {
  NbaPlayerRankInfo copyWith({
    int? pfdRank,
    double? fg3Pct,
    int? orebRank,
    double? sTL,
