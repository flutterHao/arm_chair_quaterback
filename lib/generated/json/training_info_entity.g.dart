...
TrainingInfoTraining $TrainingInfoTrainingFromJson(Map<String, dynamic> json) {
  ...
  final int? shieldCount = jsonConvert.convert<int>(json['shieldCount']);
  if (shieldCount != null) {
    trainingInfoTraining.shieldCount = shieldCount;
  }
  final int? todayBuyCount = jsonConvert.convert<int>(json['todayBuyCount']);
...
TrainingInfoBuff $TrainingInfoBuffFromJson(Map<String, dynamic> json) {
  ...
  final RxBool? show = jsonConvert.convert<RxBool>(json['show']);
  if (show != null) {
    trainingInfoBuff.show = show;
  }
  final double? scale = jsonConvert.convert<double>(json['scale']);
  if (scale != null) {
    trainingInfoBuff.scale = scale;
  }
