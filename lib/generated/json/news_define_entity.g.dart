...
NewsDefineEntity $NewsDefineEntityFromJson(Map<String, dynamic> json) {
  ...
  final String? betPlayerNum =
      jsonConvert.convert<String>(json['betPlayerNum']);
  if (betPlayerNum != null) {
    newsDefineEntity.betPlayerNum = betPlayerNum;
  }
  final String? betRankrefresh =
      jsonConvert.convert<String>(json['betRankrefresh']);
  if (betRankrefresh != null) {
    newsDefineEntity.betRankrefresh = betRankrefresh;
  }
  final String? betRewardRank =
      jsonConvert.convert<String>(json['betRewardRank']);
  ...
  final List<String>? btRankOpen = (json['btRankOpen'] as List<dynamic>?)
      ?.map((e) => jsonConvert.convert<String>(e) as String)
      .toList();
  if (btRankOpen != null) {
    newsDefineEntity.btRankOpen = btRankOpen;
  }
  final List<String>? cBetData = (json['cBetData'] as List<dynamic>?)
      ?.map((e) => jsonConvert.convert<String>(e) as String)
      .toList();
  if (cBetData != null) {
  ...
  final String? gamePlayRecent =
      jsonConvert.convert<String>(json['gamePlayRecent']);
  ...
  final String? newsRefreshNum =
      jsonConvert.convert<String>(json['newsRefreshNum']);
  if (newsRefreshNum != null) {
    newsDefineEntity.newsRefreshNum = newsRefreshNum;
  }
  final List<String>? pfBetData = (json['pfBetData'] as List<dynamic>?)
      ?.map((e) => jsonConvert.convert<String>(e) as String)
      .toList();
  if (pfBetData != null) {
    newsDefineEntity.pfBetData = pfBetData;
  }
  final List<String>? pgBetDate = (json['pgBetDate'] as List<dynamic>?)
      ?.map((e) => jsonConvert.convert<String>(e) as String)
      .toList();
  if (pgBetDate != null) {
    newsDefineEntity.pgBetDate = pgBetDate;
  }
  final List<String>? sfBetData = (json['sfBetData'] as List<dynamic>?)
      ?.map((e) => jsonConvert.convert<String>(e) as String)
      .toList();
  if (sfBetData != null) {
    newsDefineEntity.sfBetData = sfBetData;
  }
  final List<String>? sgBetData = (json['sgBetData'] as List<dynamic>?)
      ?.map((e) => jsonConvert.convert<String>(e) as String)
      .toList();
  if (sgBetData != null) {
